...
# def factorial(num):
#     if num == 0: return 1 # при num == 1, тоже возвратит 1
...
# Output: 4 3
"""
Чтобы не использовать циклы, при каждой рекурсии вводим ноовое число.
Чтобы не объявлять массивы, используем сложение строк
"""
...
# 01:40:00
'''
Разбор ДЗ-05 (см. файл "home05.py")
'''