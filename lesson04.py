...
for i in str1: # (?) 's' или 'str1'
	if i not in result: # если этой буквы (ключа) ещё не было, то	    
		print(i, end = " ") # печатаем букву (ключ), 'end' (запись в строку)
		result[i] = 1 # значение равно единице
	else: 
		st = print(f'{i}_{result[i]}', end = " ") # выводим ключ (i) 
					  	     		# и значение (result[i])
		result[i] += 1 # значeние увеличиваем на единицу
print('Output:', st)