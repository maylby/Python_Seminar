...
# for i in str1: 
# 	if i not in result: # Смысл: Если этой буквы (ключа) ещё не было, то	    
# 		print(i, end = " ") # печатаем букву (ключ), 
# 		                    # 'end' - запись в одну строку
#                             # (скрытый аргумент оператора 'print')
# 		result[i] = 1 # значение равно единице
# 	else: 
# 		print(f'{i}_{result[i]}', end = " ") # вывод ключа (i) и значения (result[i])	                                                                       
# 		result[i] += 1


# 01:03:50
# Задача для самостоятельного решения сброшена в чат урока
"""		
Сергей Сердюк 
